...
FISH_ENERGY_FOR_REPRODUCING = 0.2
FISH_ENERGY_SPENT_REPRODUCING = .01
FISH_RADIUS_FOR_REPRODUCING = .5
FISH_RADIUS_FOR_EATING = .05

PLANKTON_NUTRITIONAL_VALUE = FISH_MAX_ENERGY // 10
FISH_NUTRITIONAL_VALUE = FISH_MAX_ENERGY // 2

SHARK_VISION_RADIUS = 4
SHARK_SCARED_OF_N_FISHES = 10
SHARK_REPRODUCTION_RATE = 0.004
